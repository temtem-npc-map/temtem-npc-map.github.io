...
$(document).ready(function() {  
  ...
  var ayaan = L.marker([445.63, 348.73], {title: 'ayaan', icon: npcEarthGuardIcon}).bindTooltip('Ayaan', {className: 'tooltip'}).addTo(map);
  ayaan._icon.classList.add('ayaan');
  ayaan._icon.classList.add('combat');
  markers.push(ayaan);
  var babatunde = L.marker([451.38, 339.98], {title: 'babatunde', icon: npcEarthGuardIcon}).bindTooltip('Babatunde', {className: 'tooltip'}).addTo(map);
  babatunde._icon.classList.add('babatunde');
  babatunde._icon.classList.add('combat');
  markers.push(babatunde);
  var ife = L.marker([460.69, 348.79], {title: 'ife', icon: npcEarthGuardIcon}).bindTooltip('Ife', {className: 'tooltip'}).addTo(map);
  ife._icon.classList.add('ife');
  ife._icon.classList.add('combat');
  markers.push(ife);
  var kamili = L.marker([464.25, 344.79], {title: 'kamili', icon: npcEarthGuardIcon}).bindTooltip('Kamili', {className: 'tooltip'}).addTo(map);
  ...
  markers.push(msekwa);
  var undeadyokel = L.marker([683, 209], {title: 'undeadyokel', icon: npcGenericIcon}).bindTooltip('Undead Yokel', {className: 'tooltip'}).addTo(map);
  undeadyokel._icon.classList.add('undeadyokel');
  markers.push(undeadyokel);
  var desertvendor = L.marker([627, 270], {title: 'desertvendor', icon: npcVendorIcon}).bindTooltip('Desert Vendor', {className: 'tooltip'}).addTo(map);
  desertvendor._icon.classList.add('desertvendor');
  desertvendor._icon.classList.add('vendor');
  markers.push(desertvendor);
  var masara = L.marker([704, 328], {title: 'masara', icon: npcGenericIcon}).bindTooltip('Masara', {className: 'tooltip'}).addTo(map);
  masara._icon.classList.add('masara');
  markers.push(masara);
  var uzoma = L.marker([643, 342], {title: 'uzoma', icon: npcGenericIcon}).bindTooltip('Uzoma', {className: 'tooltip'}).addTo(map);
  uzoma._icon.classList.add('uzoma');
  markers.push(uzoma);
  var mhina = L.marker([776.8, 238.5], {title: 'mhina', icon: npcGenericIcon}).bindTooltip('Mhina', {className: 'tooltip'}).addTo(map);
  mhina._icon.classList.add('mhina');
  markers.push(mhina);
  var johari = L.marker([772.5, 254], {title: 'johari', icon: npcGenericIcon}).bindTooltip('Johari', {className: 'tooltip'}).addTo(map);
  johari._icon.classList.add('johari');
  markers.push(johari);
  var folami = L.marker([768.6, 251], {title: 'folami', icon: npcGenericIcon}).bindTooltip('Folami', {className: 'tooltip'}).addTo(map);
  folami._icon.classList.add('folami');
  markers.push(folami);
  var ayinki = L.marker([587, 777.5], {title: 'ayinki', icon: npcCombatIcon}).bindTooltip('Ayinki', {className: 'tooltip'}).addTo(map);
  ayinki._icon.classList.add('ayinki');
  ayinki._icon.classList.add('combat');
  markers.push(ayinki);
  var chidi = L.marker([616.4, 792.4], {title: 'chidi', icon: npcCombatIcon}).bindTooltip('Chidi', {className: 'tooltip'}).addTo(map);
  chidi._icon.classList.add('chidi');
  chidi._icon.classList.add('combat');
  markers.push(chidi);
  var mwiko = L.marker([613.1, 802.8], {title: 'mwiko', icon: npcCombatIcon}).bindTooltip('Mwiko', {className: 'tooltip'}).addTo(map);
  mwiko._icon.classList.add('mwiko');
  mwiko._icon.classList.add('combat');
  markers.push(mwiko);
  var yao = L.marker([634.88, 803.1], {title: 'yao', icon: npcGenericIcon}).bindTooltip('Yao', {className: 'tooltip'}).addTo(map);
  yao._icon.classList.add('yao');
  markers.push(yao);
  var nana = L.marker([576.6, 825.3], {title: 'nana', icon: npcCombatIcon}).bindTooltip('Nana', {className: 'tooltip'}).addTo(map);
  nana._icon.classList.add('nana');
  nana._icon.classList.add('combat');
  markers.push(nana);
  var iceharvester = L.marker([634, 840], {title: 'iceharvester', icon: npcCombatIcon}).bindTooltip('Ice Harvester', {className: 'tooltip'}).addTo(map);
  iceharvester._icon.classList.add('iceharvester');
  iceharvester._icon.classList.add('combat');
  markers.push(iceharvester);
  var max = L.marker([611.1, 850.1], {title: 'max', icon: npcCombatIcon}).bindTooltip('Max?!', {className: 'tooltip'}).addTo(map);
  max._icon.classList.add('max');
  max._icon.classList.add('combat');
  markers.push(max);
  var max = L.marker([606.1, 850.1], {title: 'max', icon: npcCombatIcon}).bindTooltip('Max?', {className: 'tooltip'}).addTo(map);
  max._icon.classList.add('max');
  max._icon.classList.add('combat');
  markers.push(max);
  var bitrus = L.marker([619.3, 866.4], {title: 'bitrus', icon: npcGenericIcon}).bindTooltip('Bitrus', {className: 'tooltip'}).addTo(map);
  bitrus._icon.classList.add('bitrus');
  markers.push(bitrus);
  var roxelana = L.marker([599.5, 863.1], {title: 'roxelana', icon: npcCombatIcon}).bindTooltip('Roxelana', {className: 'tooltip'}).addTo(map);
  roxelana._icon.classList.add('roxelana');
  roxelana._icon.classList.add('combat');
  markers.push(roxelana);
  var mihrimah = L.marker([591.8, 863.5], {title: 'mihrimah', icon: npcCombatIcon}).bindTooltip('Mihrimah', {className: 'tooltip'}).addTo(map);
  mihrimah._icon.classList.add('mihrimah');
  mihrimah._icon.classList.add('combat');
  markers.push(mihrimah);
  var subira = L.marker([605.3, 871.8], {title: 'subira', icon: npcGenericIcon}).bindTooltip('Subira', {className: 'tooltip'}).addTo(map);
  subira._icon.classList.add('subira');
  markers.push(subira);
  var umaru = L.marker([595.4, 903.9], {title: 'umaru', icon: npcCombatIcon}).bindTooltip('Umaru', {className: 'tooltip'}).addTo(map);
  umaru._icon.classList.add('umaru');
  umaru._icon.classList.add('combat');
  markers.push(umaru);
  var mbavi = L.marker([615.8, 908.5], {title: 'mbavi', icon: npcCombatIcon}).bindTooltip('Mbavi', {className: 'tooltip'}).addTo(map);
  mbavi._icon.classList.add('mbavi');
  mbavi._icon.classList.add('combat');
  markers.push(mbavi);
  var kyle = L.marker([582.3, 925.9], {title: 'kyle', icon: npcGenericIcon}).bindTooltip('Kyle', {className: 'tooltip'}).addTo(map);
  kyle._icon.classList.add('kyle');
  markers.push(kyle);
  var geologist = L.marker([735.6, 884.9], {title: 'geologist', icon: npcCombatIcon}).bindTooltip('Geologist', {className: 'tooltip'}).addTo(map);
  geologist._icon.classList.add('geologist');
  geologist._icon.classList.add('combat');
  markers.push(geologist);
  var glaciologist = L.marker([738.5, 888.3], {title: 'glaciologist', icon: npcCombatIcon}).bindTooltip('Glaciologist', {className: 'tooltip'}).addTo(map);
  glaciologist._icon.classList.add('glaciologist');
  glaciologist._icon.classList.add('combat');
  markers.push(glaciologist);
  var amara = L.marker([699.3, 910.4], {title: 'amara', icon: npcCombatIcon}).bindTooltip('Amara', {className: 'tooltip'}).addTo(map);
  amara._icon.classList.add('amara');
  amara._icon.classList.add('combat');
  markers.push(amara);
  var adisa = L.marker([720.6, 958.9], {title: 'adisa', icon: npcCombatIcon}).bindTooltip('Adisa', {className: 'tooltip'}).addTo(map);
  adisa._icon.classList.add('adisa');
  adisa._icon.classList.add('combat');
  markers.push(adisa);
