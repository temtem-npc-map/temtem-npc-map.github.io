...
$(document).ready(function() {  
  ...
  markers.push(lacey);
  var ngalu = L.marker([570.64, 511.5], {title: 'ngalu', icon: npcGenericIcon}).bindTooltip('Ngalu', {className: 'tooltip'}).addTo(map);
  ngalu._icon.classList.add('ngalu');
  markers.push(ngalu);
  var avery = L.marker([573.64, 511.5], {title: 'avery', icon: npcGenericIcon}).bindTooltip('Avery', {className: 'tooltip'}).addTo(map);
  avery._icon.classList.add('avery');
  markers.push(avery);
  var mrcraig = L.marker([568.64, 530.2], {title: 'mrcraig', icon: npcGenericIcon}).bindTooltip('Mr. Craig', {className: 'tooltip'}).addTo(map);
  mrcraig._icon.classList.add('mrcraig');
  markers.push(mrcraig);
  var neuronman = L.marker([575.2, 539.58], {title: 'neuronman', icon: npcGenericIcon}).bindTooltip('Neuronman', {className: 'tooltip'}).addTo(map);
  neuronman._icon.classList.add('neuronman');
  markers.push(neuronman);
  var ken = L.marker([608.86, 505.99], {title: 'ken', icon: npcGenericIcon}).bindTooltip('Ken', {className: 'tooltip'}).addTo(map);
  ken._icon.classList.add('ken');
  markers.push(ken);
  var phoebe = L.marker([603.11, 526.18], {title: 'phoebe', icon: npcGenericIcon}).bindTooltip('Phoebe', {className: 'tooltip'}).addTo(map);
  phoebe._icon.classList.add('phoebe');
  markers.push(phoebe);
  var lexi = L.marker([606.11, 526.18], {title: 'lexi', icon: npcGenericIcon}).bindTooltip('Lexi', {className: 'tooltip'}).addTo(map);
  lexi._icon.classList.add('lexi');
  markers.push(lexi);
  var maddison = L.marker([609.11, 526.18], {title: 'maddison', icon: npcGenericIcon}).bindTooltip('Maddison', {className: 'tooltip'}).addTo(map);
  maddison._icon.classList.add('maddison');
  markers.push(maddison);
  var lochburgtemporium = L.marker([606.11, 529.18], {title: 'lochburgtemporium', icon: npcVendorIcon}).bindTooltip('Lochburg Temporium', {className: 'tooltip'}).addTo(map);
  lochburgtemporium._icon.classList.add('lochburgtemporium');
  lochburgtemporium._icon.classList.add('vendor');
  markers.push(lochburgtemporium);
  var beileag = L.marker([604.96, 549.26], {title: 'beileag', icon: npcGenericIcon}).bindTooltip('Beileag', {className: 'tooltip'}).addTo(map);
  beileag._icon.classList.add('beileag');
  markers.push(beileag);
  var sima = L.marker([630, 505.39], {title: 'sima', icon: npcGenericIcon}).bindTooltip('Sima', {className: 'tooltip'}).addTo(map);
  sima._icon.classList.add('sima');
  markers.push(sima);
  var senga = L.marker([633, 505.39], {title: 'senga', icon: npcGenericIcon}).bindTooltip('Senga', {className: 'tooltip'}).addTo(map);
  senga._icon.classList.add('senga');
  markers.push(senga);
  var effie = L.marker([630.12, 475.75], {title: 'effie', icon: npcGenericIcon}).bindTooltip('Effie', {className: 'tooltip'}).addTo(map);
  effie._icon.classList.add('effie');
  markers.push(effie);
  var clyde = L.marker([645.06, 480.03], {title: 'clyde', icon: npcGenericIcon}).bindTooltip('Clyde', {className: 'tooltip'}).addTo(map);
  clyde._icon.classList.add('clyde');
  markers.push(clyde);
  var farai = L.marker([656.06, 471.4], {title: 'farai', icon: npcGenericIcon}).bindTooltip('Farai', {className: 'tooltip'}).addTo(map);
  farai._icon.classList.add('farai');
  markers.push(farai);
  var clydejr = L.marker([659.06, 471.4], {title: 'clydejr', icon: npcFurnitureIcon}).bindTooltip('Clyde Jr.', {className: 'tooltip'}).addTo(map);
  clydejr._icon.classList.add('clydejr');
  clydejr._icon.classList.add('furniture');
  markers.push(clydejr);
  var lochburgdojomc = L.marker([649.56, 488.28], {title: 'lochburgdojomc', icon: npcGenericIcon}).bindTooltip('Lochburg Dojo MC', {className: 'tooltip'}).addTo(map);
  lochburgdojomc._icon.classList.add('lochburgdojomc');
  markers.push(lochburgdojomc);
  var zachary = L.marker([652.56, 488.28], {title: 'zachary', icon: npcGenericIcon}).bindTooltip('Zachary', {className: 'tooltip'}).addTo(map);
  zachary._icon.classList.add('zachary');
  markers.push(zachary);
  var evelyn = L.marker([655.56, 488.28], {title: 'evelyn', icon: npcCombatIcon}).bindTooltip('Evelyn', {className: 'tooltip'}).addTo(map);
  evelyn._icon.classList.add('evelyn');
  evelyn._icon.classList.add('combat');
  markers.push(evelyn);
  var ryan = L.marker([649.56, 491.28], {title: 'ryan', icon: npcCombatIcon}).bindTooltip('Ryan', {className: 'tooltip'}).addTo(map);
  ryan._icon.classList.add('ryan');
  ryan._icon.classList.add('combat');
  markers.push(ryan);
  var emma = L.marker([652.56, 491.28], {title: 'emma', icon: npcGenericIcon}).bindTooltip('Emma', {className: 'tooltip'}).addTo(map);
  emma._icon.classList.add('emma');
  markers.push(emma);
  var mkunde = L.marker([655.56, 491.28], {title: 'mkunde', icon: npcGenericIcon}).bindTooltip('Mkunde', {className: 'tooltip'}).addTo(map);
  mkunde._icon.classList.add('mkunde');
  markers.push(mkunde);
  var atsuko = L.marker([649.56, 494.28], {title: 'atsuko', icon: npcGenericIcon}).bindTooltip('Atsuko', {className: 'tooltip'}).addTo(map);
  atsuko._icon.classList.add('atsuko');
  markers.push(atsuko);
  var murphy = L.marker([652.56, 494.28], {title: 'murphy', icon: npcCombatIcon}).bindTooltip('Murphy', {className: 'tooltip'}).addTo(map);
