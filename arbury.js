...
$(document).ready(function() {  
  ...
  markers.push(murdag);
  var brodric = L.marker([654.06, 515.3], {title: 'brodric', icon: npcGenericIcon}).bindTooltip('Brodric', {className: 'tooltip'}).addTo(map);
  brodric._icon.classList.add('brodric');
  markers.push(brodric);
  var greer = L.marker([652.69, 527.55], {title: 'greer', icon: npcGenericIcon}).bindTooltip('Greer', {className: 'tooltip'}).addTo(map);
  greer._icon.classList.add('greer');
  markers.push(greer);
  var mairead = L.marker([652.69, 530.06], {title: 'mairead', icon: npcGenericIcon}).bindTooltip('Mairead', {className: 'tooltip'}).addTo(map);
  mairead._icon.classList.add('mairead');
  markers.push(mairead);
  var ruairidh = L.marker([629.06, 549.07], {title: 'ruairidh', icon: npcGenericIcon}).bindTooltip('Ruairidh', {className: 'tooltip'}).addTo(map);
  ruairidh._icon.classList.add('ruairidh');
  markers.push(ruairidh);
  var ainsley = L.marker([577.13, 442.21], {title: 'ainsley', icon: npcCombatIcon}).bindTooltip('Ainsley', {className: 'tooltip'}).addTo(map);
  ainsley._icon.classList.add('ainsley');
  ainsley._icon.classList.add('combat');
  markers.push(ainsley);
  var rory = L.marker([607.34, 430.22], {title: 'rory', icon: npcCombatIcon}).bindTooltip('Rory', {className: 'tooltip'}).addTo(map);
  rory._icon.classList.add('rory');
  rory._icon.classList.add('combat');
  markers.push(rory);
  var lachlan = L.marker([623.57, 447.39], {title: 'lachlan', icon: npcCombatIcon}).bindTooltip('Lachlan', {className: 'tooltip'}).addTo(map);
  lachlan._icon.classList.add('lachlan');
  lachlan._icon.classList.add('combat');
  markers.push(lachlan);
  var weemoira = L.marker([638.98, 437.6], {title: 'weemoira', icon: npcMovingCombatIcon}).bindTooltip('Wee Moira', {className: 'tooltip'}).addTo(map);
  weemoira._icon.classList.add('weemoira');
  weemoira._icon.classList.add('moving');
  weemoira._icon.classList.add('combat');
  markers.push(weemoira);
  var fergus = L.marker([653.88, 428.97], {title: 'fergus', icon: npcCombatIcon}).bindTooltip('Fergus', {className: 'tooltip'}).addTo(map);
  fergus._icon.classList.add('fergus');
  fergus._icon.classList.add('combat');
  markers.push(fergus);
  var fiona = L.marker([660.03, 396.47], {title: 'fiona', icon: npcCombatIcon}).bindTooltip('Fiona', {className: 'tooltip'}).addTo(map);
  fiona._icon.classList.add('fiona');
  fiona._icon.classList.add('combat');
  markers.push(fiona);
  var graham = L.marker([643.73, 406.6], {title: 'graham', icon: npcCombatIcon}).bindTooltip('Graham', {className: 'tooltip'}).addTo(map);
  graham._icon.classList.add('graham');
  graham._icon.classList.add('combat');
  markers.push(graham);
  var skye = L.marker([641.28, 406.6], {title: 'skye', icon: npcCombatIcon}).bindTooltip('Skye', {className: 'tooltip'}).addTo(map);
  skye._icon.classList.add('skye');
  skye._icon.classList.add('combat');
  markers.push(skye);
  var malcolm = L.marker([613.98, 402.62], {title: 'malcolm', icon: npcCombatIcon}).bindTooltip('Malcolm', {className: 'tooltip'}).addTo(map);
  malcolm._icon.classList.add('malcolm');
  malcolm._icon.classList.add('combat');
  markers.push(malcolm);
  var ailsa = L.marker([612.85, 402.62], {title: 'ailsa', icon: npcCombatIcon}).bindTooltip('Ailsa', {className: 'tooltip'}).addTo(map);
