...
$(document).ready(function() {  
  ...
  var anaknovice = L.marker([349.13, 711.12], {title: 'anaknovice', icon: npcCombatIcon}).bindTooltip('Anak Novice', {className: 'tooltip'}).addTo(map);
  anaknovice._icon.classList.add('anaknovice');
  anaknovice._icon.classList.add('combat');
  markers.push(anaknovice);
  var anakinitiate = L.marker([356.26, 694.74], {title: 'anakinitiate', icon: npcCombatIcon}).bindTooltip('Anak Initiate', {className: 'tooltip'}).addTo(map);
  anakinitiate._icon.classList.add('anakinitiate');
  anakinitiate._icon.classList.add('combat');
  markers.push(anakinitiate);
  var anakdisciple = L.marker([363.26, 711], {title: 'anakdisciple', icon: npcCombatIcon}).bindTooltip('Anak Disciple', {className: 'tooltip'}).addTo(map);
  anakdisciple._icon.classList.add('anakdisciple');
  anakdisciple._icon.classList.add('combat');
  markers.push(anakdisciple);
  var anakpriest = L.marker([371.51, 702.74], {title: 'anakpriest', icon: npcCombatIcon}).bindTooltip('Anak Priest', {className: 'tooltip'}).addTo(map);
