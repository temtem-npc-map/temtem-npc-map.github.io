...
$(document).ready(function() {  
  ...
  markers.push(yuta);
  var drunkguard = L.marker([416, 600.1], {title: 'drunkguard', icon: npcGenericIcon}).bindTooltip('Drunk guard', {className: 'tooltip'}).addTo(map);
  drunkguard._icon.classList.add('drunkguard');
  markers.push(drunkguard);
  var hermit = L.marker([450.6, 663.8], {title: 'hermit', icon: npcGenericIcon}).bindTooltip('Hermit', {className: 'tooltip'}).addTo(map);
  hermit._icon.classList.add('hermit');
  markers.push(hermit);
  var wastedguard = L.marker([417.4, 602.1], {title: 'wastedguard', icon: npcGenericIcon}).bindTooltip('Wasted Guard', {className: 'tooltip'}).addTo(map);
  wastedguard._icon.classList.add('wastedguard');
  markers.push(wastedguard);
  var aileanna = L.marker([433.8, 583.9], {title: 'aileanna', icon: npcGenericIcon}).bindTooltip('Aileanna', {className: 'tooltip'}).addTo(map);
  aileanna._icon.classList.add('aileanna');
  markers.push(aileanna);
  var akihiko = L.marker([433.8, 586.9], {title: 'akihiko', icon: npcGenericIcon}).bindTooltip('Akihiko', {className: 'tooltip'}).addTo(map);
  akihiko._icon.classList.add('akihiko');
  markers.push(akihiko);
  var finlay = L.marker([433.8, 589.9], {title: 'finlay', icon: npcGenericIcon}).bindTooltip('Finlay', {className: 'tooltip'}).addTo(map);
  finlay._icon.classList.add('finlay');
  markers.push(finlay);
  var hana = L.marker([433.8, 592.9], {title: 'hana', icon: npcGenericIcon}).bindTooltip('Hana', {className: 'tooltip'}).addTo(map);
  hana._icon.classList.add('hana');
  markers.push(hana);
  var hikaru = L.marker([430.8, 583.9], {title: 'hikaru', icon: npcGenericIcon}).bindTooltip('Hikaru', {className: 'tooltip'}).addTo(map);
  hikaru._icon.classList.add('hikaru');
  markers.push(hikaru);
  var katagiri = L.marker([430.8, 586.9], {title: 'katagiri', icon: npcGenericIcon}).bindTooltip('Katagiri', {className: 'tooltip'}).addTo(map);
  katagiri._icon.classList.add('katagiri');
  markers.push(katagiri);
  var master = L.marker([430.8, 589.9], {title: 'master', icon: npcGenericIcon}).bindTooltip('Master', {className: 'tooltip'}).addTo(map);
  master._icon.classList.add('master');
  markers.push(master);
  var naoki = L.marker([430.8, 592.9], {title: 'naoki', icon: npcGenericIcon}).bindTooltip('Naoki', {className: 'tooltip'}).addTo(map);
  naoki._icon.classList.add('naoki');
  markers.push(naoki);
  var naomi = L.marker([427.8, 583.9], {title: 'naomi', icon: npcGenericIcon}).bindTooltip('Naomi', {className: 'tooltip'}).addTo(map);
  naomi._icon.classList.add('naomi');
  markers.push(naomi);
  var ryokanvendor = L.marker([427.8, 586.9], {title: 'ryokanvendor', icon: npcVendorIcon}).bindTooltip('Ryokan Vendor', {className: 'tooltip'}).addTo(map);
  ryokanvendor._icon.classList.add('ryokanvendor');
  ryokanvendor._icon.classList.add('vendor');
  markers.push(ryokanvendor);
  var ai = L.marker([498.75, 744.07], {title: 'ai', icon: npcCombatIcon}).bindTooltip('Ai', {className: 'tooltip'}).addTo(map);
  ai._icon.classList.add('ai');
  ai._icon.classList.add('combat');
  markers.push(ai);
  var ambusheryamabushi = L.marker([505.75, 822.03], {title: 'ambusheryamabushi', icon: npcCombatIcon}).bindTooltip('Ambusher Yamabushi', {className: 'tooltip'}).addTo(map);
  ambusheryamabushi._icon.classList.add('ambusheryamabushi');
  ambusheryamabushi._icon.classList.add('combat');
  markers.push(ambusheryamabushi);
  var bespectacledgent = L.marker([542, 795.55], {title: 'bespectacledgent', icon: npcMovingCombatIcon}).bindTooltip('Bespectacled Gent', {className: 'tooltip'}).addTo(map);
  bespectacledgent._icon.classList.add('bespectacledgent');
  bespectacledgent._icon.classList.add('moving');
  bespectacledgent._icon.classList.add('combat');
  markers.push(bespectacledgent);
  var cipankipilgrim = L.marker([546.75, 699.6], {title: 'cipankipilgrim', icon: npcCombatIcon}).bindTooltip('Cipanki Pilgrim', {className: 'tooltip'}).addTo(map);
  cipankipilgrim._icon.classList.add('cipankipilgrim');
  cipankipilgrim._icon.classList.add('combat');
  markers.push(cipankipilgrim);
  var cockyronin = L.marker([481.25, 730.33], {title: 'cockyronin', icon: npcCombatIcon}).bindTooltip('Cocky Ronin', {className: 'tooltip'}).addTo(map);
  cockyronin._icon.classList.add('cockyronin');
  cockyronin._icon.classList.add('combat');
  markers.push(cockyronin);
  var daisuke = L.marker([558, 764.06], {title: 'daisuke', icon: npcCombatIcon}).bindTooltip('Daisuke', {className: 'tooltip'}).addTo(map);
  daisuke._icon.classList.add('daisuke');
  daisuke._icon.classList.add('combat');
  markers.push(daisuke);
  var distractedpeasant = L.marker([485.75, 657.11], {title: 'distractedpeasant', icon: npcCombatIcon}).bindTooltip('Distracted Peasant', {className: 'tooltip'}).addTo(map);
  distractedpeasant._icon.classList.add('distractedpeasant');
  distractedpeasant._icon.classList.add('combat');
  markers.push(distractedpeasant);
  var exbelsotoscout = L.marker([585.5, 774.06], {title: 'exbelsotoscout', icon: npcCombatIcon}).bindTooltip('Ex-Belsoto Scout', {className: 'tooltip'}).addTo(map);
  exbelsotoscout._icon.classList.add('exbelsotoscout');
  exbelsotoscout._icon.classList.add('combat');
  markers.push(exbelsotoscout);
  var exbelsotoscout = L.marker([575.3, 775.8], {title: 'exbelsotoscout', icon: npcCombatIcon}).bindTooltip('Ex-Belsoto Scout', {className: 'tooltip'}).addTo(map);
  exbelsotoscout._icon.classList.add('exbelsotoscout');
  exbelsotoscout._icon.classList.add('combat');
  markers.push(exbelsotoscout);
  var frustratedtamer = L.marker([552.25, 842.02], {title: 'frustratedtamer', icon: npcCombatIcon}).bindTooltip('Frustrated Tamer', {className: 'tooltip'}).addTo(map);
  frustratedtamer._icon.classList.add('frustratedtamer');
  frustratedtamer._icon.classList.add('combat');
  markers.push(frustratedtamer);
  var haru = L.marker([582.25, 763.06], {title: 'haru', icon: npcCombatIcon}).bindTooltip('Haru', {className: 'tooltip'}).addTo(map);
  haru._icon.classList.add('haru');
  haru._icon.classList.add('combat');
  markers.push(haru);
  var junpei = L.marker([514, 746.8], {title: 'junpei', icon: npcCombatIcon}).bindTooltip('Junpei', {className: 'tooltip'}).addTo(map);
  junpei._icon.classList.add('junpei');
  junpei._icon.classList.add('combat');
  markers.push(junpei);
  var kasumi = L.marker([519.3, 827], {title: 'kasumi', icon: npcCombatIcon}).bindTooltip('Kasumi', {className: 'tooltip'}).addTo(map);
  kasumi._icon.classList.add('kasumi');
  kasumi._icon.classList.add('combat');
  markers.push(kasumi);
  var kenji = L.marker([555, 749.6], {title: 'kenji', icon: npcCombatIcon}).bindTooltip('Kenji', {className: 'tooltip'}).addTo(map);
  kenji._icon.classList.add('kenji');
  kenji._icon.classList.add('combat');
  markers.push(kenji);
  var makoto = L.marker([551, 845.8], {title: 'makoto', icon: npcCombatIcon}).bindTooltip('Makoto', {className: 'tooltip'}).addTo(map);
  makoto._icon.classList.add('makoto');
  makoto._icon.classList.add('combat');
  markers.push(makoto);
  var midori = L.marker([559.75, 722.8], {title: 'midori', icon: npcCombatIcon}).bindTooltip('Midori', {className: 'tooltip'}).addTo(map);
  midori._icon.classList.add('midori');
  midori._icon.classList.add('combat');
  markers.push(midori);
  var omninesianpilgrin = L.marker([550.3, 697.9], {title: 'omninesianpilgrin', icon: npcCombatIcon}).bindTooltip('Omninesian Pilgrin', {className: 'tooltip'}).addTo(map);
  omninesianpilgrin._icon.classList.add('omninesianpilgrin');
  omninesianpilgrin._icon.classList.add('combat');
  markers.push(omninesianpilgrin);
  var priestguard = L.marker([571, 819.3], {title: 'priestguard', icon: npcCombatIcon}).bindTooltip('Priest Guard', {className: 'tooltip'}).addTo(map);
  priestguard._icon.classList.add('priestguard');
  priestguard._icon.classList.add('combat');
  markers.push(priestguard);
  var ritsuko = L.marker([545.5, 817.8], {title: 'ritsuko', icon: npcCombatIcon}).bindTooltip('Ritsuko', {className: 'tooltip'}).addTo(map);
  ritsuko._icon.classList.add('ritsuko');
  ritsuko._icon.classList.add('combat');
  markers.push(ritsuko);
  var sereneyamabushi = L.marker([484.5, 774.3], {title: 'sereneyamabushi', icon: npcCombatIcon}).bindTooltip('Serene Yamabushi', {className: 'tooltip'}).addTo(map);
  sereneyamabushi._icon.classList.add('sereneyamabushi');
  sereneyamabushi._icon.classList.add('combat');
  markers.push(sereneyamabushi);
  var shiro = L.marker([561.5, 766.81], {title: 'shiro', icon: npcCombatIcon}).bindTooltip('Shiro', {className: 'tooltip'}).addTo(map);
  shiro._icon.classList.add('shiro');
  shiro._icon.classList.add('combat');
  markers.push(shiro);
  var studiousyamabushi = L.marker([465, 831.5], {title: 'studiousyamabushi', icon: npcCombatIcon}).bindTooltip('Studious Yamabushi', {className: 'tooltip'}).addTo(map);
  studiousyamabushi._icon.classList.add('studiousyamabushi');
  studiousyamabushi._icon.classList.add('combat');
  markers.push(studiousyamabushi);
  var tamersnob = L.marker([571.8, 832.8], {title: 'tamersnob', icon: npcCombatIcon}).bindTooltip('Tamer snob', {className: 'tooltip'}).addTo(map);
  tamersnob._icon.classList.add('tamersnob');
  tamersnob._icon.classList.add('combat');
  markers.push(tamersnob);
  var yuki = L.marker([563, 768.06], {title: 'yuki', icon: npcCombatIcon}).bindTooltip('Yuki', {className: 'tooltip'}).addTo(map);
  yuki._icon.classList.add('yuki');
  yuki._icon.classList.add('combat');
  markers.push(yuki);
  var yukiko = L.marker([546, 818.03], {title: 'yukiko', icon: npcCombatIcon}).bindTooltip('Yukiko', {className: 'tooltip'}).addTo(map);
  yukiko._icon.classList.add('yukiko');
  yukiko._icon.classList.add('combat');
  markers.push(yukiko);
  var zealousyamabushi = L.marker([462.5, 828.03], {title: 'zealousyamabushi', icon: npcCombatIcon}).bindTooltip('Zealous Yamabushi', {className: 'tooltip'}).addTo(map);
  zealousyamabushi._icon.classList.add('zealousyamabushi');
  zealousyamabushi._icon.classList.add('combat');
  markers.push(zealousyamabushi);
  var berhano = L.marker([651.5, 611.8], {title: 'berhano', icon: npcGenericIcon}).bindTooltip('Berhano', {className: 'tooltip'}).addTo(map);
  berhano._icon.classList.add('berhano');
  markers.push(berhano);
  var carlos = L.marker([650.8, 613.8], {title: 'carlos', icon: npcGenericIcon}).bindTooltip('Carlos', {className: 'tooltip'}).addTo(map);
  carlos._icon.classList.add('carlos');
  markers.push(carlos);
  var elderlypilgrim = L.marker([575.3, 569.3], {title: 'elderlypilgrim', icon: npcCombatIcon}).bindTooltip('Elderly Pilgrim?', {className: 'tooltip'}).addTo(map);
  elderlypilgrim._icon.classList.add('elderlypilgrim');
  elderlypilgrim._icon.classList.add('combat');
  markers.push(elderlypilgrim);
  var shiratama = L.marker([655.8, 606.01], {title: 'shiratama', icon: npcGenericIcon}).bindTooltip('Shiratama', {className: 'tooltip'}).addTo(map);
  shiratama._icon.classList.add('shiratama');
  markers.push(shiratama);
  var nervouspilgrim = L.marker([702.5, 583.01], {title: 'nervouspilgrim', icon: npcCombatIcon}).bindTooltip('Nervous Pilgrim', {className: 'tooltip'}).addTo(map);
  nervouspilgrim._icon.classList.add('nervouspilgrim');
  nervouspilgrim._icon.classList.add('combat');
  markers.push(nervouspilgrim);
  var devoutpriest = L.marker([719.5, 492.28], {title: 'devoutpriest', icon: npcCombatIcon}).bindTooltip('Devout Priest', {className: 'tooltip'}).addTo(map);
  devoutpriest._icon.classList.add('devoutpriest');
  devoutpriest._icon.classList.add('combat');
  markers.push(devoutpriest);
  var denizanpriest = L.marker([571.8, 542.5], {title: 'denizanpriest', icon: npcCombatIcon}).bindTooltip('Denizan Priest', {className: 'tooltip'}).addTo(map);
  denizanpriest._icon.classList.add('denizanpriest');
  denizanpriest._icon.classList.add('combat');
  markers.push(denizanpriest);
  var tiredpilgrim = L.marker([606, 605.8], {title: 'tiredpilgrim', icon: npcCombatIcon}).bindTooltip('Tired Pilgrim', {className: 'tooltip'}).addTo(map);
  tiredpilgrim._icon.classList.add('tiredpilgrim');
  tiredpilgrim._icon.classList.add('combat');
  markers.push(tiredpilgrim);
  var afolabi = L.marker([440.6, 97.4], {title: 'afolabi', icon: npcGenericIcon}).bindTooltip('Afolabi', {className: 'tooltip'}).addTo(map);
  afolabi._icon.classList.add('afolabi');
  markers.push(afolabi);
  var akane = L.marker([420, 141.3], {title: 'akane', icon: npcGenericIcon}).bindTooltip('Akane', {className: 'tooltip'}).addTo(map);
  akane._icon.classList.add('akane');
  markers.push(akane);
  var asuka = L.marker([474.9, 129.3], {title: 'asuka', icon: npcGenericIcon}).bindTooltip('Asuka', {className: 'tooltip'}).addTo(map);
  asuka._icon.classList.add('asuka');
  markers.push(asuka);
  var ayumi = L.marker([423.3, 97.6], {title: 'ayumi', icon: npcGenericIcon}).bindTooltip('Ayumi', {className: 'tooltip'}).addTo(map);
  ayumi._icon.classList.add('ayumi');
  markers.push(ayumi);
  var haruto = L.marker([449, 74.3], {title: 'haruto', icon: npcGenericIcon}).bindTooltip('Haruto', {className: 'tooltip'}).addTo(map);
  haruto._icon.classList.add('haruto');
  markers.push(haruto);
  var ikue = L.marker([413.9, 98.2], {title: 'ikue', icon: npcGenericIcon}).bindTooltip('Ikue', {className: 'tooltip'}).addTo(map);
  ikue._icon.classList.add('ikue');
  markers.push(ikue);
  var itsuki = L.marker([451.9, 85.9], {title: 'itsuki', icon: npcGenericIcon}).bindTooltip('Itsuki', {className: 'tooltip'}).addTo(map);
  itsuki._icon.classList.add('itsuki');
  markers.push(itsuki);
  var josefa = L.marker([494.1, 137.6], {title: 'josefa', icon: npcGenericIcon}).bindTooltip('Josefa', {className: 'tooltip'}).addTo(map);
  josefa._icon.classList.add('josefa');
  markers.push(josefa);
  var kazuya = L.marker([477.6, 105.7], {title: 'kazuya', icon: npcGenericIcon}).bindTooltip('Kazuya', {className: 'tooltip'}).addTo(map);
  kazuya._icon.classList.add('kazuya');
  markers.push(kazuya);
  var kei = L.marker([466.4, 70.9], {title: 'kei', icon: npcGenericIcon}).bindTooltip('Kei', {className: 'tooltip'}).addTo(map);
  kei._icon.classList.add('kei');
  markers.push(kei);
  var kyo = L.marker([466.4, 74.8], {title: 'kyo', icon: npcGenericIcon}).bindTooltip('Kyo', {className: 'tooltip'}).addTo(map);
  kyo._icon.classList.add('kyo');
  markers.push(kyo);
  var offdutyguard = L.marker([439.5, 113.9], {title: 'offdutyguard', icon: npcGenericIcon}).bindTooltip('Off-duty Guard', {className: 'tooltip'}).addTo(map);
  offdutyguard._icon.classList.add('offdutyguard');
  markers.push(offdutyguard);
  var onsenshimareception = L.marker([428.3, 142.8], {title: 'onsenshimareception', icon: npcGenericIcon}).bindTooltip('Onsenshima Reception', {className: 'tooltip'}).addTo(map);
  onsenshimareception._icon.classList.add('onsenshimareception');
  markers.push(onsenshimareception);
  var rebecca = L.marker([460.1, 92.3], {title: 'rebecca', icon: npcGenericIcon}).bindTooltip('Rebecca', {className: 'tooltip'}).addTo(map);
  rebecca._icon.classList.add('rebecca');
  markers.push(rebecca);
  var dapenisa = L.marker([472.6, 77.8], {title: 'dapenisa', icon: npcGenericIcon}).bindTooltip('Dapenisa', {className: 'tooltip'}).addTo(map);
  dapenisa._icon.classList.add('dapenisa');
  markers.push(dapenisa);
  var suzuki = L.marker([475, 81.7], {title: 'suzuki', icon: npcCombatIcon}).bindTooltip('Suzuki', {className: 'tooltip'}).addTo(map);
  suzuki._icon.classList.add('suzuki');
  suzuki._icon.classList.add('combat');
  markers.push(suzuki);
  var digitaldesigner = L.marker([518, 277.3], {title: 'digitaldesigner', icon: npcDigitalGuardIcon}).bindTooltip('Digital Designer', {className: 'tooltip'}).addTo(map);
  digitaldesigner._icon.classList.add('digitaldesigner');
  digitaldesigner._icon.classList.add('combat');
  markers.push(digitaldesigner);
  var digitaltechnologist = L.marker([524.3, 269.7], {title: 'digitaltechnologist', icon: npcDigitalGuardIcon}).bindTooltip('Digital Technologist', {className: 'tooltip'}).addTo(map);
  digitaltechnologist._icon.classList.add('digitaltechnologist');
  digitaltechnologist._icon.classList.add('combat');
  markers.push(digitaltechnologist);
  var digitaldeveloper = L.marker([530.9, 277.5], {title: 'digitaldeveloper', icon: npcDigitalGuardIcon}).bindTooltip('Digital Developer', {className: 'tooltip'}).addTo(map);
  digitaldeveloper._icon.classList.add('digitaldeveloper');
  digitaldeveloper._icon.classList.add('combat');
  markers.push(digitaldeveloper);
  var digitalqa = L.marker([540.1, 273.5], {title: 'digitalqa', icon: npcDigitalGuardIcon}).bindTooltip('Digital QA', {className: 'tooltip'}).addTo(map);
